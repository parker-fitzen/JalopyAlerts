...
const MOCK_ALERTS = [
  {
    ...
    hasPush: true,
    newKeys: ["1020:2010:TOYOTA:PRIUS:42", "1022:2011:TOYOTA:PRIUS:89"],
    notification: {
      title: "Jalopy Alerts: 2006–2013 TOYOTA PRIUS",
      body: "2 new arrivals @ JJ BOISE and JJ NAMPA — 03-25-2026\n- Vehicle: 2010 TOYOTA PRIUS • Location: JJ BOISE • Row: 42\n- Vehicle: 2011 TOYOTA PRIUS • Location: JJ NAMPA • Row: 89",
  ...
  },
  {
    ...
    hasPush: true,
    newKeys: ["1022:2008:HONDA:ACCORD:9"],
    notification: {
      title: "Jalopy Alerts: 2005+ HONDA",
      body: "1 new arrival @ JJ NAMPA — 03-24-2026\n- Vehicle: 2008 HONDA ACCORD • Location: JJ NAMPA • Row: 9",
...
const MOCK_ROWS = [
  { yardId: "1020", yardName: "BOISE", year: 2010, make: "TOYOTA", model: "PRIUS", row: "42" },
  { yardId: "1022", yardName: "NAMPA", year: 2011, make: "TOYOTA", model: "PRIUS", row: "89" },
  { yardId: "1021", yardName: "CALDWELL", year: 2012, make: "TOYOTA", model: "CAMRY", row: "5" },
  { yardId: "1022", yardName: "NAMPA", year: 2008, make: "HONDA", model: "ACCORD", row: "9" },
];
